...
log = logging.getLogger("helix.model_routing")
...
_MODEL_ROUTING_STORAGE_KEY = "helix:model-routing"
...
def _provider_has_credentials(provider: str) -> bool:
    ...
    ``helix.ai._provider_has_credentials``). Lazy import to avoid a cycle —
    ``helix.ai`` imports this module at load time.
    """
    try:
