...
from helix.db import get_agents, get_db, kv_get
...
def _bot_error_log_path() -> Path:
    return Path(__file__).resolve().parent.parent / ".tmp" / "logs" / "helix_bot.err.log"
...
def _probe_hyperliquid_connection(testnet: bool) -> dict[str, Any]:
    from helix.exchange.hyperliquid import get_account_value, get_positions
