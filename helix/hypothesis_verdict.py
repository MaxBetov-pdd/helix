...
from helix.hypotheses import get_hypothesis, update_hypothesis_status
...
def _call_llm(prompt: str) -> str:
    """Thin wrapper so tests can mock without importing helix.ai machinery."""
    from helix.ai import call_ai_sync, resolve_available_provider
