...
from helix.research_contract import ResearchContract, build_research_contract, default_research_settings
...
def build_research_context(
    *,
    ...
    the Helix identity / trading rules (IDENTITY.md) and the data schema
    ...
    if identity:
        sections.append(f"# HELIX — IDENTITY & RULES\n{identity}")
