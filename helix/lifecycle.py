...
Helix runs as a Tauri sidecar. When the user closes the desktop window,
...
from helix.task_progress import list_resumable_tasks, mark_interrupted, resume_task

log = logging.getLogger("helix.lifecycle")
