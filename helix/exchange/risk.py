...
from helix.db import get_db, kv_get, kv_set, kv_set_best_effort, log_activity, next_container_id
from helix.sim.clock import get_now, get_today, sim_kv_key
from helix.system_pause import is_system_paused
...
log = logging.getLogger("helix.exchange.risk")
    ...
    with _POSITION_LOCK:
        ...
        if mode == "live":
            try:
                ...
                try:
                    from helix.exchange import books as _books
                ...
                if acct_val > 0:
                    ...
                    _books_on = False
                    try:
                        from helix.exchange import books as _books_mod
...
def _snapshot_exchange_state(
    ...
    from helix.exchange.hyperliquid import get_all_mids, get_open_orders, get_positions
...
def _cancel_reduce_only_orders_for_asset(
    ...
    *,
    ...
    from helix.exchange.hyperliquid import cancel_order
...
def _repair_position_protection(
    ...
    *,
    ...
    try:
        from helix.exchange.hyperliquid import place_protective_stop
...
def _insert_recovered_trade(
    ...
    *,
    ...
    from helix.config import get_execution_mode as _get_execution_mode
...
def _recover_exit_from_fills(
    ...
    *,
    ...
    try:
        from helix.exchange.hyperliquid import get_user_fills
...
def close_all_positions() -> list[dict]:
    ...
    """
    from helix.exchange.hyperliquid import close_position, get_positions
