...
_DEFAULT_HEADERS = {
    "User-Agent": "Mozilla/5.0 (compatible; Helix/1.0; +https://github.com/openai)",
...
def _guard_request_host(request: "httpx.Request") -> None:
    ...
    """
    from helix.security.url_safety import UnsafeUrlError
...
def _fetch_transcript_via_ytdlp(video_id: str) -> list[dict[str, Any]] | None:
    ...
    with tempfile.TemporaryDirectory(prefix="helix-ytsub-") as tmpdir:
