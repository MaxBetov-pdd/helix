...
from helix.config import OPENCLAW_WORKSPACE, WORKSPACE_DIR, LEGACY_WORKSPACE_DIR, ensure_dirs

console = Console()
log = logging.getLogger("helix.workspace")
...
def write_workspace(filename: str, content: str):
    ...
    # Mirror writes to legacy workspace to keep `.judex` and `.helix` in sync.
...
def _create_defaults():
    """Create default workspace files from templates shipped with Helix."""
