...
import helix.agents.tools_research  # noqa: F401
...
_BACKTESTING_PERM_NAMES = {
    "helix_list_datasets", "helix_create_strategy", "helix_run_backtest",
    "helix_run_optimization", "helix_run_verdict", "helix_get_results",
}
...
def _ensure_tools_imported():
    ...
    import helix.agents.tools_research    # noqa: F401
    import helix.agents.tools_assistant   # noqa: F401
    # Phase 5 / P5-T05: assign default categories by name pattern.
    from helix.agents.tool_registry import apply_default_categorization
...
# ---------------------------------------------------------------------------
# Chat toolsets — single source of truth for the operator <-> Helix chat.
#
# Two tiers:
...
CHAT_ASK_TOOL_NAMES: frozenset[str] = frozenset({
    ...
    "helix_list_datasets",      # backtesting datasets available
    "helix_get_results",        # read backtest/optimization results
})
