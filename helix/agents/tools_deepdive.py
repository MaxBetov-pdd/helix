...
def _custom_dir() -> Path:
    override = os.environ.get("HELIX_STRATEGIES_CUSTOM_DIR")
    if override:
        return Path(override)
    # Package-relative, like every other custom-strategy consumer. The old
    # CWD-relative "helix/strategies/custom" fallback pointed at a directory
...
def _update_default_params(*, params: dict, rationale: str, thread_id: str) -> str:
    ...
    from helix.api_core import update_strategy_default_params
