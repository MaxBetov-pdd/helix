...
def _apply_crucible_dethrone(
    ...
    *,
    ...
    try:
        from helix.crucibles import apply_dethrone_decision
...
def _apply_skill_update_proposal(
    ...
    Re-uses :func:`helix.quant_skills.write_skill` which transparently bumps
...
def _apply_regime_champion_promotion(
    ...
    try:
        from helix.lab_matrix_engine import apply_champion_promotion
