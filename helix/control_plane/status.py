...
from helix.db import _now, get_db, kv_get, kv_set
from helix.circuit_breaker import hl_account_breaker, hl_price_breaker, hl_trade_breaker
from helix.exchange.risk import get_risk_status, is_trading_allowed
from helix.runtime_health import compute_runtime_code_fingerprint, normalize_daemon_state
from helix.system_mode_policy import get_paused_manual_counts
from helix.system_pause import get_system_pause_state
...
def _runtime_health_summary() -> dict[str, object]:
    ...
    bot_owns_runtime = os.environ.get("HELIX_BOT_OWNS_RUNTIME", "").strip().lower() in {
        "1",
        "true",
        "yes",
        "on",
    ...
    if bot_owns_runtime:
        ...
        try:
            from helix.runtime_worker import get_api_task_worker_status
...
def get_system_heartbeat() -> dict[str, object]:
    ...
    from helix.api_domains import analytics as analytics_domain
    ...
    from helix.api_domains import tasks as tasks_domain
    from helix.api_domains import trading as trading_domain
    from helix.control_plane.approvals import get_approvals_list
    from helix.notifications import get_actionable_notification_summary
...
def get_dashboard(require_account_connection: bool = False) -> dict[str, object]:
    ...
    if should_fetch_live_account:
        try:
            ...
            from helix.api_domains.trading import _resolve_exchange_testnet
