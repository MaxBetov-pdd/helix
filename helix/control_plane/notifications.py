...
def _record_operator_action(action_key: str, *, status: str, summary: str, details: dict | None = None) -> None:
    from helix.control_plane.ops import _record_operator_action as _ops_record_operator_action
...
def _record_operator_action_error(action_key: str, message: str, *, details: dict | None = None) -> None:
    from helix.control_plane.ops import _record_operator_action_error as _ops_record_operator_action_error
