...
# Ensure helix package is importable
...
class BotRunner:
    ...
    async def _check_backend_health() -> bool:
        ...
        port = os.environ.get("HELIX_PORT", "8003")
    ...
    def _fetch_live_price(self, symbol: str) -> float | None:
        ...
        try:
            from helix.data import get_exchange
        ...
        for pair in pairs:
            try:
                ...
                if df is not None and not df.empty:
                    ...
                    recent = df.tail(20)
                    from helix.market_data import dataframe_to_ohlcv_rows
    ...
    def _execute_open(
        ...
        *,
        ...
        from helix.db import execute_bot_trade
    ...
    async def _event_loop(self):
        ...
        from helix.bot_factory.engine import run_decision_cycle, MIN_LLM_INTERVAL_SECONDS
