...
Maps between Helix canonical format and provider-specific formats
...
def from_polygon(ticker: str) -> tuple[str, AssetClass]:
    """Convert Polygon.io ticker to canonical Helix format + asset class.
...
def timeframe_to_polygon(timeframe: str) -> tuple[int, str]:
    """Convert Helix timeframe to Polygon multiplier + timespan.
