...
from helix.lab_strategy_pool import (
    LAB_STRATEGY_SOURCE_REGISTRY,
    list_strategy_pool_candidates,
    normalize_strategy_sources,
)
from helix.strategies.backtest import backtest_strategy, expand_strategy_trade_modes, validate_backtest_risk_controls
from helix.strategies.base import BaseStrategy
from helix.strategies.registry import discover, get_all
...
log = logging.getLogger("helix.lab_matrix_engine")
...
def _disable_backtest_production_persistence():
    import helix.strategies.backtest as backtest_module
...
def _create_champion_approval(
    *,
    ...
    from helix.db import create_approval, log_activity
