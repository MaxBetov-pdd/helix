...
* **ChatGPT subscription OAuth tokens** — the kind minted by the Codex CLI login
  flow we mirror in :mod:`helix.auth.openai` — are rejected by that platform
...
log = logging.getLogger("helix.codex_responses")
...
_CODEX_USER_AGENT = "codex_cli_rs/0.0.0 (Helix)"
