...
from helix.strategies import indicators as _indicators
...
# Sourced from the central indicator registry (helix.strategies.indicators) so
...
def compute_indicator(df: pd.DataFrame, ind: dict) -> dict[str, pd.Series]:
    ...
    Thin delegator to the central registry (helix.strategies.indicators) which
