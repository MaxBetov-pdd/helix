...
`helix/strategies/builtin/` — those are the reference implementations and
match the numerical conventions used by `_vectorized_signals` in
`helix/strategies/backtest.py`.
...
1. Save the file to `helix/strategies/custom/`
