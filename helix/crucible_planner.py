...
from helix.crucible_tasks import CANDIDATE_ACTION_KINDS
...
def _strategy_spawn_limit_exhausted(crucible_id: str) -> bool:
    try:
        from helix.hypotheses import get_hypothesis_spawn_stats
        ...
        if _strategy_count(crucible_id) == 0:
            ...
            return _action(
                ...
                description=(
                    ...
                    "Call helix_create_strategy or register_strategy with the exact provided "
...
def run_crucible_planner_cycle(*, limit: int = 3) -> dict[str, Any]:
    ...
    from helix.hypothesis_promotion import (
