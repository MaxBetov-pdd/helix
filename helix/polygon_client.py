...
from helix.config import get_polygon_api_key, redact_api_key
from helix.rate_limiter import RateLimiter
from helix.symbol_mapping import AssetClass, detect_asset_class, timeframe_to_polygon, to_polygon

log = logging.getLogger("helix.polygon")
...
class PolygonClient:
    ...
    def fetch_aggs(
        ...
        *,
        ...
        Args:
            symbol: Helix canonical symbol (AAPL, BTC-USDT, EUR-USD, etc.)
            timeframe: Helix timeframe (1m, 5m, 1h, 4h, 1d, etc.)
