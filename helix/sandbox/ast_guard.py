...
# Hard caps. Configurable via helix.config.sandbox in a later phase.
...
FORBIDDEN_IMPORTS: frozenset[str] = frozenset(
    {
        ...
        # the import tripwire in helix/__init__.py. Reject it here too so a
...
FORBIDDEN_CALLS: frozenset[str] = frozenset(
    {
        ...
        # ~/.helix credentials/DB; globals/vars/locals expose module globals
