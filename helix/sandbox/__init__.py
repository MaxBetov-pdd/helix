...
log = logging.getLogger("helix.sandbox")
...
def run_code(
    ...
    if IS_WINDOWS:
        ...
        # passes every secret-bearing var (ANTHROPIC_API_KEY, HELIX_HL_API_SECRET,
        # HELIX_ENCRYPTION_KEY, …) straight into AI-generated / prompt-injectable
