...
# NOTE: registered under the canonical /api/strategies namespace, NOT /api/helix.
# The HelixV1CompatMiddleware rewrites every /api/helix/* path to /api/* before
# routing, so a route registered under /api/helix/* is unreachable (the rewritten
