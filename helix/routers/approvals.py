...
from helix.control_plane import approval_modes as control_plane_approval_modes
from helix.control_plane.models import ApprovalDecisionBody, ApprovalHandoffBody, ApprovalTroubleshootBody
from helix.control_plane.smart_approval import classify_approval
...
def classify_approval_route(approval_id: int) -> dict[str, Any]:
    ...
    from helix.db import get_approval as db_get_approval
