...
from helix.api_domains import data as data_domain
from helix.api_security import require_operator_access
from helix import strategy_lifecycle as lifecycle
from helix.routers import verdict as verdict_routes
from helix.verdict_engine import parse_backtesting_dataset_context
...
def read_prebuilt_strategies():
    from helix.strategies.catalog import get_prebuilt_catalog
...
def scan_strategy_intake(body: IntakeScanBody | None = None):
    ...
    """
    from helix.strategies.intake import scan_custom_strategies
...
def get_recent_intake(limit: int = 20):
    ...
    from helix.strategies.intake import get_recent_intake_events
...
def get_quant_skills(
    ...
    from helix.quant_skills import list_skills
...
def get_hypotheses():
    ...
    from helix.quant_skills import list_hypotheses
...
def get_quant_skills_stats():
    ...
    from helix.quant_skills import get_stats
    return get_stats()
...
def promote_hypothesis_endpoint(hypothesis_id: str):
    ...
    from helix.quant_skills import force_promote_hypothesis
...
def dismiss_hypothesis_endpoint(hypothesis_id: str):
    ...
    from helix.quant_skills import dismiss_hypothesis
...
def get_quant_skill_detail(name: str):
    ...
    from helix.quant_skills import get_skill_detail
...
def archive_quant_skill(name: str):
    ...
    from helix.quant_skills import delete_skill
...
def get_ai_dropzone_context():
    ...
    from helix.strategies.params import _FAMILY_ALLOWED_PARAMS, _COMMON_ALLOWED_PARAMS
...
def create_ai_dropzone_session(body: AiDropzoneSessionBody):
    ...
    from helix.ai_dropzone_sessions import create_session
...
def list_ai_dropzone_sessions(limit: int = 20, include_closed: bool = True):
    ...
    from helix.ai_dropzone_sessions import list_sessions
...
def get_ai_dropzone_session(session_id: str):
    ...
    from helix.ai_dropzone_sessions import get_session_detail
...
def close_ai_dropzone_session(session_id: str):
    ...
    from helix.ai_dropzone_sessions import close_session
...
def list_indicators():
    ...
    from helix.strategies import indicators as indicators_registry
...
async def post_backtesting_optimize(request: core.Request):
    """Compatibility endpoint for helix_run_optimization tool payloads."""
    body = await request.json()
...
async def post_backtesting_verdict(request: core.Request):
    """Compatibility endpoint for helix_run_verdict tool payloads."""
    body = await request.json()
...
def lab_now_working():
    ...
    """
    from helix.db import get_db, kv_get
