...
from helix import config as helix_config
from helix.dataeng.identity import SymbolRef, to_ref
...
def default_data_root() -> Path:
    ...
    if os.environ.get("HELIX_HOME"):
        return helix_config.HELIX_HOME / "data"
    return Path(__file__).resolve().parents[2] / "data"


def default_catalog_path() -> Path:
    return helix_config.HELIX_HOME / "data" / "catalog.duckdb"
