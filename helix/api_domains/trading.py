...
from helix.db import _now, count_trades, get_all_trades, get_db, get_open_trades, get_recent_trades, kv_get, log_activity
from helix.exchange import hyperliquid as hl
from helix.exchange.risk import release, sync_from_trades
...
def mark_trade_failed(trade_id: str, body) -> dict:
    ...
    from helix.scanner import _fail_unfilled_open_trade
...
def _cancel_reduce_only_orders_for_asset(asset: str, *, testnet: bool) -> list[dict]:
    from helix.exchange.hyperliquid import cancel_order, get_open_orders
