...
from helix.gauntlet.models import ROBUSTNESS_STEP_KEYS, STEP_TERMINAL_STATUSES
from helix.gauntlet.settings import build_settings_snapshot, normalize_required_tests
from helix.gauntlet.store import get_latest_workflow_for_strategy, get_workflow_detail
...
def get_strategy_gauntlet_status(strategy_id: str) -> dict[str, Any]:
    ...
    from helix.gauntlet.store import sanitize_non_finite
