# SPDX-FileCopyrightText: 2026 MaxBetov-pdd
...
def _install_ta_import_tripwire() -> None:
    ...
    This tripwire runs at `helix` package import time and installs a
    ...
    else), attempts to import it from within helix code will fail loudly.
    """
    import sys
        ...
        def find_spec(self, fullname, path=None, target=None):  # noqa: D401
            ...
            if root in _BANNED_ROOTS:
                raise ModuleNotFoundError(
                    ...
                    "permanently banned in helix — use native pandas/numpy "
                    "instead. See helix/strategies/STRATEGY_TEMPLATE.md and "
