...
log = logging.getLogger("helix.jobs.overnight_summary")
...
def _gather_lab_stats(cutoff_iso: str) -> dict[str, Any]:
    ...
    try:
        from helix.lab_db import init_lab_db, get_lab_db, get_blacklist_summary
...
def _gather_pipeline_health_stats() -> dict[str, Any]:
    ...
    try:
        from helix.lab_db import get_lab_meta
        from helix.lab_worker_service import PIPELINE_PROGRESS_META_KEY
