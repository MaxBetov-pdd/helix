...
from helix.agents.tools_deepdive import set_deepdive_strategy, clear_deepdive_strategy
from helix.db import get_db
from helix.deepdive_db import (
    append_message,
    get_thread,
    list_messages,
)

log = logging.getLogger("helix.deepdive")
...
def _build_deepdive_tools() -> list[dict]:
    ...
    import helix.agents.tools_deepdive  # noqa: F401
