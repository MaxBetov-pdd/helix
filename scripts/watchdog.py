...
on any Helix internals that might be broken.
"""
...
HELIX_HOME = Path(os.environ.get("HELIX_HOME", os.path.expanduser("~/.helix")))
BOT_LOCK = HELIX_HOME / "bot.lock"
DAEMON_LOCK = HELIX_HOME / "daemon.lock"
DB_PATH = HELIX_HOME / "helix.db"
LOG_PATH = HELIX_HOME / "logs" / "watchdog.log"
POLL_INTERVAL = 60  # seconds between checks
SCHEDULER_STALE_THRESHOLD = 300  # 5 minutes — scheduler must tick within this window
BOT_START_CMD = [sys.executable, "-m", "helix", "bot", "start"]
