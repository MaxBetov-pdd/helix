...
from helix.db import get_db  # noqa: E402
from helix.sim.clock import get_now  # noqa: E402
from helix.trade_state import is_local_only_paper_trade, parse_trade_signal_data  # noqa: E402
    ...
    with get_db() as conn:
        ...
        if total == 0:
            print(
                ...
                "HELIX_HOME to the live home (e.g. ~/.helix) and run inside the "
