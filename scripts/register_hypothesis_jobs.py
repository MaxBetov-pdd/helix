...
"""
from helix.scheduler import add_job, enable_job
...
def main() -> None:
    ...
    enable_job("helix-hypothesis-verdict-loop", enabled=True)
    ...
    enable_job("helix-hypothesis-promotion-loop", enabled=True)
    ...
    enable_job("helix-hypothesis-revisit-pass", enabled=True)
