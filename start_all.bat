...
if "%HELIX_HOME%"=="" set "HELIX_HOME=%USERPROFILE%\.helix"
if "%HELIX_ENABLE_REGIME_LAB%"=="" set "HELIX_ENABLE_REGIME_LAB=0"
if "%VITE_ENABLE_REGIME_LAB%"=="" set "VITE_ENABLE_REGIME_LAB=%HELIX_ENABLE_REGIME_LAB%"
...
echo [start_all.bat] HELIX_HOME=%HELIX_HOME%
echo [start_all.bat] HELIX_ENABLE_REGIME_LAB=%HELIX_ENABLE_REGIME_LAB%
