<script lang="ts">
	...
	import { getHelixAgents, getHelixAgentTasks, getHelixLogs } from '$lib/api';
	import type { HelixAgent, HelixAgentTask } from '$lib/api';
	...
	async function loadEntries() {
		try {
			const rawLogs = await getHelixLogs(120);
