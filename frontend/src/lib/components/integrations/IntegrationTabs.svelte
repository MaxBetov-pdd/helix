	...
	const tabs = [
		{
			...
			href: '/integrations',
			label: 'AI Clients',
			description: 'Connect outside assistants to Helix and watch Drop Zone sessions',
		},
		{
			id: 'tool-servers',
			href: '/integrations/mcp',
			label: 'Agent Tool Servers',
			description: 'Connect external MCP tools for Helix agents to call',
		},
	] as const;
</script>
		...
		<div class="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
			<div>
				...
				<p class="mt-1 max-w-3xl text-[11px] leading-5 text-gray-500">
					One MCP control room: AI clients connect into Helix, while agent tool servers let
					Helix agents connect out to external tools.
				</p>
			</div>
