...
<aside class="relative z-40 w-60 flex-shrink-0 border-r border-[#222] bg-black flex flex-col">
	<div class="px-3 py-4 border-b border-[#222] flex items-center justify-center gap-2">
		<div class="w-2 h-2 bg-orange-500 shrink-0" title="helix"></div>
		<div class="text-sm font-mono lowercase tracking-wide text-orange-500">helix</div>
	</div>
	...
	<div class="px-3 pb-2 text-center">
		<a
			href="https://github.com/MaxBetov-pdd659/Helix"
			target="_blank"
			rel="noopener noreferrer"
			class="text-[10px] text-gray-600 hover:text-gray-400 transition-colors"
			title="Helix source code (AGPL-3.0)"
		>Source · AGPL-3.0</a>
	</div>
