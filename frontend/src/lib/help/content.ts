...
Helix uses Optuna for parameter optimization, providing efficient search without exhaustive grid testing.`,
		proTips: [
...
Crypto exchanges typically charge 0.1% (10 bps) per trade, meaning a round-trip (entry + exit) costs 0.2%. At 200 trades per year, this is 40% annual cost!`,
	...
	webhook_url: {
		...
		category: 'data',
		fullDescription: 'Helix posts event messages to this endpoint. Keep it private to avoid alert spoofing.'
	},
	notification_level: {
	...
	degradation_alert_pct: {
		...
		category: 'risk',
		fullDescription: 'If recent performance falls by this amount, Helix flags potential regime drift or edge decay.',
		interpretations: [
	...
	helix_service_status: {
		id: 'helix_service_status',
		term: 'Helix Service Status',
	...
	oauth_quick_link: {
		...
		category: 'strategy',
		fullDescription: 'Use this to initiate an OAuth grant flow and authorize Helix against the provider account.',
		proTips: [
	...
	oauth_expires_at: {
		...
		category: 'risk',
		fullDescription: 'Supports either ISO-8601 UTC timestamps or epoch milliseconds, and helps Helix determine when credentials should be renewed.',
		proTips: [
	...
	agent_model_provider_setting: {
		...
		category: 'strategy',
		fullDescription: 'Must match an authenticated provider key recognized by Helix.',
	...
	operations_settings: {
		...
		category: 'optimization',
		fullDescription: 'These settings directly control how aggressively Helix generates work, how fast queues drain, how scanner execution is permitted and routed, and how quickly stale tasks are recovered.',
		proTips: [
	...
	adaptive_pipeline_throughput_setting: {
		...
		category: 'optimization',
		fullDescription: 'When enabled, Helix adjusts testing-cycle throughput based on quick_screen/gauntlet backlog, cadence, and queue pressure. This helps move strong candidates forward quickly and purge weak candidates sooner.',
		interpretations: [
