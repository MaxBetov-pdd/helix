import type { HelixNotification } from '$lib/api';
...
export function formatNotificationContent(item: Pick<HelixNotification, 'summary' | 'body'>): NotificationFormattedContent {
