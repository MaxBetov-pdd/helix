<script lang="ts">
	...
	import {
		...
		getHelixRisk,
		resetTradingHalt,
		type HelixDashboardResponse,
		type HelixRiskStatus,
	} from '$lib/api';
	import { triggerEmergencyHalt } from '$lib/api/helix';
	...
	let risk: HelixRiskStatus | null = null;
	let loading = true;
	let error = '';
	let actionMessage = '';
	let resetBusy = false;
...
<svelte:head>
	<title>Risk Command | Helix</title>
