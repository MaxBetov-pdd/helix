<script lang="ts">
	 ...
	 *
	 * Saving a key (setHelixAuthProvider) connects; Disconnect
	 * (deleteHelixAuthProvider) revokes. After any mutation we reload the
	...
	function connectedLabel(p: HelixAuthProviderStatus): boolean {
