...
def test_mark_crucible_viable_requires_evidence_id(helix_db):
    h = _hyp()
...
def test_proven_verdict_never_leaves_evidence_ref_null(helix_db):
    ...
    with patch("helix.hypothesis_verdict._call_llm", return_value=json.dumps({"verdict": "proven", "rationale": "r"})):
