...
def test_run_agent_task_executes_trade_execution_deterministically(helix_db, monkeypatch):
    ...
    monkeypatch.setattr("helix.scanner.execute_trade_intent", _fake_execute_trade_intent)
