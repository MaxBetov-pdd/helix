...
from helix.api_core import get_pipeline_motion_log
...
def test_pipeline_motion_log_includes_promotion_and_demotion_with_context(helix_db):
    strategy_id = "S12345"
...
def test_pipeline_motion_log_ignores_no_change_events(helix_db):
    strategy_id = "S54321"
...
def test_pipeline_motion_log_route_returns_list(helix_db):
...
def test_pipeline_motion_log_excludes_non_paper_live_motions(helix_db):
    strategy_id = "S11111"
