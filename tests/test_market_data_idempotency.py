...
from helix.market_data_collector import (
    METRIC_FUNDING_RATE,
    _store_batch,
    _store_data_point,
)
...
def test_store_data_point_reports_duplicate_skip(caplog):
    ...
    with caplog.at_level(logging.DEBUG, logger="helix.market_data_collector"):
...
def test_store_batch_returns_inserted_count_not_row_count(caplog):
    ...
    with caplog.at_level(logging.INFO, logger="helix.market_data_collector"):
