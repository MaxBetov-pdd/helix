...
def test_list_hypotheses_returns_operator_fields(helix_db):
    from helix.api import app
    from helix.hypotheses import create_hypothesis, record_data_gap
...
def test_get_hypothesis_detail_returns_strategies_artifacts_and_data_gaps(helix_db):
    from helix.api import app
...
def test_list_hypotheses_accepts_manager_view_and_search(helix_db):
    from helix.api import app
    from helix.hypotheses import archive_hypothesis, create_hypothesis
...
def test_hypothesis_lifecycle_endpoints_transition_and_return_payload(helix_db):
    from helix.api import app
...
def test_bulk_hypothesis_lifecycle_endpoints_accept_selected_ids(helix_db):
    from helix.api import app
    from helix.hypotheses import create_hypothesis
...
def test_ranked_data_gaps_endpoint_returns_top_blockers(helix_db):
    from helix.api import app
    from helix.hypotheses import create_hypothesis, record_data_gap
...
def test_list_hypotheses_pagination_is_backward_compatible_and_slices(helix_db):
    from helix.api import app
    from helix.hypotheses import create_hypothesis
...
def test_hypotheses_counts_endpoint_returns_all_buckets(helix_db):
    from helix.api import app
    from helix.hypotheses import archive_hypothesis, create_hypothesis, trash_hypothesis
...
def test_ranked_data_gaps_surface_requesting_hypotheses(helix_db):
    from helix.api import app
    from helix.hypotheses import create_hypothesis, record_data_gap
...
def test_get_hypothesis_detail_returns_404_for_unknown_id(helix_db):
    from helix.api import app
...
def test_strategy_container_includes_parent_hypothesis_id(helix_db):
    from helix.api import app
    from helix.hypotheses import create_hypothesis
...
def test_detail_excludes_cached_content_by_default(helix_db):
    from helix.api import app
...
def test_detail_includes_cached_content_when_requested(helix_db):
    from helix.api import app
    from helix.hypotheses import add_hypothesis_artifact, create_hypothesis
...
def test_discover_endpoint_triggers_discovery_on_operator_demand(helix_db):
