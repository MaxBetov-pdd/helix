...
from helix.db import get_approval, get_db
...
def test_researching_crucible_planner_cycle_creates_one_candidate_task(helix_db):
...
def test_protected_viable_crucible_archive_request_creates_contested_approval(helix_db):
    crucible = _make_crucible("researching")
