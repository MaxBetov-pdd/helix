...
def test_normalize_daemon_state_marks_stale_dead_process(monkeypatch, helix_db):
    ...
    monkeypatch.setattr("helix.runtime_health.pid_exists", lambda pid: False)
    monkeypatch.setattr(
        "helix.runtime_health.remove_stale_daemon_lock",
