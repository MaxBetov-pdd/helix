...
`helix/strategies/indicators.py` module if one exists.
"""
...
EXCLUDED = {
    ...
    REPO_ROOT / "helix" / "strategies" / "custom" / "_broken",
}
...
def _git_tracked_files() -> set[Path] | None:
    ...
    The ban targets the committed codebase. `helix/strategies/custom/` is
