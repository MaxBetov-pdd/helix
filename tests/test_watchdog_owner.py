...
from helix.watchdog_owner import acquire_watchdog_owner_lock, release_watchdog_owner_lock
...
"""
    ...
    try:
        ...
        from helix.watchdog_owner import acquire_watchdog_owner_lock, get_watchdog_owner_status
...
def test_watchdog_owner_status_recovers_stale_owner_file(tmp_path):
    ...
    from helix.watchdog_owner import acquire_watchdog_owner_lock, get_watchdog_owner_status, release_watchdog_owner_lock
