from helix.strategies.backtest import backtest_strategy, walk_forward


def test_backtest_strategy_rejects_unsupported_risk_controls(helix_db):
...
def test_walk_forward_rejects_unsupported_risk_controls(helix_db):
    result = walk_forward(
