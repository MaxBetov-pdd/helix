...
def test_session_markers_use_persisted_signal_results_before_recomputing(helix_db, monkeypatch):
    session = {
...
def test_session_markers_coalesce_repeated_persisted_signals(helix_db, monkeypatch):
    session = {
