...
class TestBotCRUD:
    def test_create_and_get_bot(self, helix_db):
        from helix.db import create_bot, get_bot
    ...
    def test_list_bots(self, helix_db):
        from helix.db import create_bot, list_bots
    ...
    def test_update_bot_creates_version(self, helix_db):
        from helix.db import create_bot, update_bot, get_bot, get_bot_config_versions
    ...
    def test_delete_bot(self, helix_db):
        from helix.db import create_bot, delete_bot, get_bot

        bot_id = create_bot({"name": "Doomed", "model": "gpt-4.1-mini"})
        delete_bot(bot_id)
        assert get_bot(bot_id) is None

    def test_delete_running_bot_raises(self, helix_db):
        from helix.db import create_bot, delete_bot, set_bot_status
    ...
    def test_clone_bot(self, helix_db):
        from helix.db import create_bot, clone_bot, get_bot
    ...
    def test_json_fields_round_trip(self, helix_db):
        from helix.db import create_bot, get_bot
...
class TestBotStatus:
    def test_set_and_get_status(self, helix_db):
        from helix.db import create_bot, set_bot_status, get_bot_status
    ...
    def test_heartbeat(self, helix_db):
        from helix.db import create_bot, heartbeat_bot, get_bot_status
    ...
    def test_increment_errors(self, helix_db):
        from helix.db import create_bot, increment_bot_errors
    ...
    def test_reset_errors(self, helix_db):
        from helix.db import create_bot, increment_bot_errors, reset_bot_errors, get_bot_status
    ...
    def test_increment_llm_calls(self, helix_db):
        from helix.db import create_bot, increment_bot_llm_calls
    ...
    def test_get_running_bots(self, helix_db):
        from helix.db import create_bot, set_bot_status, get_running_bots
...
class TestDecisionLog:
    def test_log_and_retrieve(self, helix_db):
        from helix.db import create_bot, log_bot_decision, get_bot_decisions
...
class TestBotTradeExecution:
    def test_execute_bot_trade(self, helix_db):
        from helix.db import create_bot, execute_bot_trade, get_recent_trades
...
class TestTemplates:
    def test_create_and_list_templates(self, helix_db):
        from helix.db import create_bot_template, list_bot_templates
    ...
    def test_delete_builtin_template_raises(self, helix_db):
        from helix.db import create_bot_template, delete_bot_template
    ...
    def test_seed_builtin_templates(self, helix_db):
        from helix.bot_factory.templates import seed_builtin_templates
        from helix.db import list_bot_templates
...
class TestCircuitBreaker:
    def test_check_passes_initially(self, helix_db):
        from helix.db import create_bot
        from helix.bot_factory.circuit_breaker import check_circuit_breaker, check_llm_daily_cap
    ...
    def test_circuit_breaker_trips_on_errors(self, helix_db):
        from helix.db import create_bot
        from helix.bot_factory.circuit_breaker import (
    ...
    def test_success_resets_errors(self, helix_db):
        from helix.db import create_bot
        from helix.bot_factory.circuit_breaker import (
            check_circuit_breaker,
            record_failure,
    ...
    def test_llm_cap_trips(self, helix_db):
        from helix.db import create_bot
        from helix.bot_factory.circuit_breaker import check_llm_daily_cap, record_llm_call
...
class TestEngine:
    def test_assemble_prompt(self):
        from helix.bot_factory.engine import assemble_prompt
    ...
    def test_parse_llm_response_json(self):
        from helix.bot_factory.engine import _parse_llm_response
    ...
    def test_enforce_risk_limits_blocks_excess_positions(self):
        from helix.bot_factory.engine import enforce_risk_limits
    ...
    def test_quantize_qty_is_fractional(self):
        ...
        from helix.bot_factory.engine import _quantize_qty
    ...
    def test_memory_query_builder_reflects_market_state(self):
        ...
        from helix.bot_factory.runner import _build_memory_query
    ...
    def test_unrealized_pnl_long(self):
        from helix.bot_factory.runner import _compute_unrealized_pnl
    ...
    def test_drawdown_pct_trips_when_below_peak(self):
        from helix.bot_factory.runner import _drawdown_pct
    ...
    def test_drawdown_enforcement_flow(self):
        ...
        from helix.bot_factory.runner import _compute_unrealized_pnl, _drawdown_pct
    ...
    def test_decision_cycle_circuit_breaker(self, helix_db):
        import asyncio
        from helix.db import create_bot
        from helix.bot_factory.engine import run_decision_cycle
        from helix.bot_factory.circuit_breaker import record_failure
    ...
    def test_decision_cycle_uses_configured_model_without_fallback(self, helix_db):
        import asyncio
        from helix.bot_factory import engine
        ...
        with (
            ...
            patch("helix.ai.normalize_provider_and_model", return_value=("openai", "gpt-4.1-mini")) as normalize_mock,
            patch("helix.ai.call_ai", new_callable=AsyncMock, return_value='{"action":"HOLD","reasoning":"stay flat"}') as call_ai_mock,
        ):
...
class TestModels:
    def test_bot_config_create_defaults(self):
        from helix.bot_factory.models import BotConfigCreate
    ...
    def test_bot_config_update_partial(self):
        from helix.bot_factory.models import BotConfigUpdate
...
class TestAPIRoutes:
    def test_list_bots_empty(self, helix_db):
    ...
    def test_update_bot(self, helix_db):
        from fastapi.testclient import TestClient
        from helix.api import app
    ...
    def test_templates_crud(self, helix_db):
        from fastapi.testclient import TestClient
        from helix.api import app
    ...
    def test_bot_not_found(self, helix_db):
        from fastapi.testclient import TestClient
        from helix.api import app
    ...
    def test_kill_all(self, helix_db):
        from fastapi.testclient import TestClient
        from helix.api import app
    ...
    def test_decisions_empty(self, helix_db):
        from fastapi.testclient import TestClient
        from helix.api import app
    ...
    def test_versions_empty(self, helix_db):
        from fastapi.testclient import TestClient
        from helix.api import app
...
class TestBotPaperTrading:
    ...
    def test_close_bot_trade_updates_status_and_pnl(self, helix_db):
        """SELL closes the OPEN row instead of inserting a new short row."""
        from helix.db import close_bot_trade, execute_bot_trade, get_db
    ...
    def test_close_bot_trade_deducts_fees(self, helix_db):
        """Entry + exit fees are subtracted from gross P&L at close."""
        from helix.db import close_bot_trade, execute_bot_trade
    ...
    def test_rehydrate_open_positions(self, helix_db):
    ...
    def test_rehydrate_includes_sl_tp(self, helix_db):
        """SL/TP levels from open are round-tripped via signal_data."""
        from helix.db import execute_bot_trade, get_open_bot_positions
    ...
    def test_close_by_trade_id_leaves_other_direction(self, helix_db):
    ...
    def test_close_credits_realized_pnl(self, helix_db):
        """close_bot_trade atomically credits the bot's realized_pnl."""
        from helix.db import close_bot_trade, execute_bot_trade, get_bot_equity_state
    ...
    def test_reconcile_realized_from_ledger(self, helix_db):
    ...
    def test_accrue_funding_reduces_realized_and_reconciles(self, helix_db):
    ...
    def test_capital_change_rebases_watermark(self, helix_db):
    ...
    def test_equity_state_persists(self, helix_db):
    ...
    def test_reset_equity_state(self, helix_db):
        from helix.db import (
    ...
    def test_slippage_adjusts_fill_price(self):
        ...
        from helix.bot_factory.runner import _apply_slippage
    ...
    def test_fee_usd(self):
        ...
        from helix.bot_factory.runner import _fee_usd
    ...
    def test_sl_tp_trigger_long(self):
        ...
        from helix.bot_factory.runner import _check_sl_tp_trigger
    ...
    def test_compute_sl_tp_prices(self):
        from helix.bot_factory.runner import _compute_sl_tp_prices
    ...
    def test_funding_accrual_prorated(self):
        ...
        from helix.bot_factory.runner import _accrue_funding_cost
    ...
    def test_mark_to_market_handles_zero_price(self):
        ...
        from helix.bot_factory.runner import BotRunner
    ...
    def test_orphan_reconcile_closes_inactive_bots(self, helix_db):
    ...
    def test_orphan_reconcile_dry_run(self, helix_db):
        from helix.db import (
            create_bot, execute_bot_trade, get_db,
            reconcile_orphaned_bot_trades,
        )
    ...
    def test_engine_prompt_uses_realized_pnl(self, helix_db):
    ...
    def test_positions_api_endpoint(self, helix_db):
        """/api/bot-factory/bots/{id}/positions returns snapshot with open rows."""
        from fastapi.testclient import TestClient
        from helix.api import app
        from helix.db import create_bot, execute_bot_trade
...
class TestBotLifecyclePhase2:
    ...
    def test_build_isolated_env_forwards_resolved_provider_key(self, monkeypatch):
        ...
        from helix.bot_factory.manager import _build_isolated_env
    ...
    def test_build_isolated_env_forwards_chroma_guard(self, monkeypatch):
        ...
        monkeypatch.setenv("HELIX_DISABLE_CHROMA_IN_PROCESS", "1")
        env = _build_isolated_env({"id": "b1", "model": "gpt-4.1-mini"})
        assert env.get("HELIX_DISABLE_CHROMA_IN_PROCESS") == "1"

    def test_daily_cap_resets_on_new_day(self, helix_db):
        """PERSIST-7: a stale reset date is treated as a fresh day so a
        daily-cap-paused bot can resume without a real LLM call."""
        from helix.bot_factory.circuit_breaker import check_llm_daily_cap
        from helix.db import create_bot, get_db, set_bot_status
    ...
    def test_start_bot_clears_stale_running(self, helix_db, monkeypatch):
        """LIFE-7: a 'running' label with a dead PID doesn't block restart."""
        from helix.bot_factory import manager as mgr
        from helix.db import create_bot, set_bot_status
    ...
    def test_delete_closes_open_trades(self, helix_db):
        """PERSIST-1/2: deleting a bot closes its OPEN paper trades (no phantom
        exposure) and removes the config."""
        from helix.api_domains.bot_factory import api_delete_bot
        from helix.db import create_bot, execute_bot_trade, get_bot, get_open_bot_positions
    ...
    def test_get_bot_trade_stats(self, helix_db):
    ...
    def test_version_snapshot_excludes_volatile(self, helix_db):
        """PERSIST-5: config-history snapshots omit status/updated_at churn."""
        from helix.db import create_bot, get_bot_config_versions, update_bot
    ...
    def test_bot_memory_disabled_is_noop(self, monkeypatch):
        ...
        from helix.bot_factory.memory import BotMemory
    ...
    def test_garbage_llm_response_passes_not_errors(self, helix_db):
        """TEST-4: a non-JSON LLM response becomes a HOLD/pass, never an error,
        so a flaky model can't trip the circuit breaker."""
        import asyncio

        from helix.bot_factory.engine import run_decision_cycle
        from helix.db import create_bot, get_bot, get_bot_status, set_bot_status

        bot_id = create_bot({"name": "G", "model": "gpt-4.1-mini"})
        set_bot_status(bot_id, "running")
        cfg = get_bot(bot_id)
        with patch("helix.ai.call_ai", new=AsyncMock(return_value="total nonsense, not json at all")):
