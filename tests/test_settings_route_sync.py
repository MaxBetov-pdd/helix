"""Execution-mode route behavior for unified Helix API."""

from helix.api import ExecutionModeBody, post_execution_mode
from helix.config import get_execution_mode, set_execution_mode


def test_update_execution_mode_paper_via_route(helix_db):
...
def test_update_execution_mode_live_rejected_via_route(helix_db):
...
def test_update_execution_mode_requires_confirmation(helix_db):
