"""Tests for helix.quant_skills module."""
...
def tmp_skills_dir(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("helix.quant_skills.HYPOTHESES_DIR", hypotheses_dir)
    monkeypatch.setattr("helix.quant_skills.ARCHIVED_DIR", archived_dir)
