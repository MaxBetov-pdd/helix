...
Covers ``helix.agents.tool_registry`` extensions:
...
from helix.agents import tool_registry as tr
from helix.agents.context import reset_tool_context, set_tool_context
from helix.agents.tool_registry import (
    ToolDef,
    VALID_CONTEXTS,
...
@pytest.fixture
def synthetic_registry(helix_db, monkeypatch):
