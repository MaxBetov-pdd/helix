...
"""
from helix.api_domains.hypotheses import _research_contract_for
...
def test_research_contract_for_benchmarking_unlocks_external_sources(helix_db):
...
def test_contract_survives_runner_coercion(helix_db):
...
def test_non_benchmarking_lane_keeps_external_sources_closed(helix_db):
    h = create_hypothesis(
        title="t", market_thesis="m", mechanism="x", why_now=None,
