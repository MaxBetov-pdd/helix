"""Tests for helix.binance_vision — BinanceVisionClient."""
...
from helix.binance_vision import BinanceVisionClient
...
def test_probe_start_date_returns_tuple():
    ...
    with patch("httpx.get", side_effect=[mock_resp_404, mock_resp_404, mock_resp_404, mock_resp_200]):
        ...
        from helix.binance_vision import _bv_start_cache
...
def test_needs_backfill_old_data():
    ...
    with patch("helix.binance_vision.BinanceVisionClient.probe_start_date", return_value=(2020, 1)):
