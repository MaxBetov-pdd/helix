...
from helix import skill_outcomes as so
...
def test_paper_to_live_graduated_triggers_positive_closure(env, monkeypatch):
    ...
    helix_db.kv_set("helix:settings", {"auto_approve_promotions": "true"})
    monkeypatch.setattr(
...
def test_record_outcome_failure_does_not_block_transition(env, monkeypatch):
    ...
    monkeypatch.setattr("helix.skill_outcomes.record_outcome", _boom)
