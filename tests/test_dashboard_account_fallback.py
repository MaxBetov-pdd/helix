...
@_skip_no_hl
def test_get_dashboard_defaults_to_initial_capital_in_paper_mode(helix_db, monkeypatch):
    ...
    monkeypatch.setattr("helix.exchange.hyperliquid.get_account_value", _raise_exchange_error)
...
@_skip_no_hl
def test_get_dashboard_strict_raises_when_hyperliquid_unavailable(helix_db, monkeypatch):
    from helix.control_plane import status as control_plane_status
