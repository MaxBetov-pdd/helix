...
def test_validate_candidate_strategy_creation_rejects_agent_without_planner_task(helix_db):
...
def test_validate_candidate_strategy_creation_allows_running_planner_candidate_task(helix_db):
    from helix.crucible_tasks import validate_candidate_strategy_creation
...
def test_validate_candidate_strategy_creation_rejects_mismatched_requested_hypothesis(helix_db):
    from helix.crucible_tasks import validate_candidate_strategy_creation
...
def test_validate_candidate_strategy_creation_rejects_wrong_agent_running_task(helix_db):
    from helix.crucible_tasks import validate_candidate_strategy_creation
...
def test_validate_candidate_strategy_creation_allows_matching_payload_hypothesis_alias(helix_db):
    from helix.crucible_tasks import validate_candidate_strategy_creation
...
def test_validate_candidate_strategy_creation_allows_hypothesis_promotion_loop_candidate(helix_db):
    from helix.crucible_tasks import validate_candidate_strategy_creation
...
def test_validate_candidate_strategy_creation_recovers_missing_task_display_id(helix_db):
    from helix.crucible_tasks import validate_candidate_strategy_creation
...
def test_brain_create_strategy_persists_strategy_provenance(helix_db, monkeypatch):
    hypothesis_id = _create_hypothesis()
    monkeypatch.setattr("helix.lab_features.is_pipeline_saturated", lambda: (False, 0, ""))
