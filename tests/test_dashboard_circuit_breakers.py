...
from helix.circuit_breaker import State
...
def _stub_dashboard_deps(monkeypatch, *, breaker_states=None):
    ...
    import helix.circuit_breaker as cb_mod
...
def test_dashboard_includes_circuit_breakers_all_closed(helix_db, monkeypatch):
...
def test_dashboard_circuit_breakers_reflect_open_state(helix_db, monkeypatch):
...
def test_dashboard_circuit_breakers_all_open(helix_db, monkeypatch):
    _stub_dashboard_deps(monkeypatch, breaker_states={
        "price": State.OPEN,
        "trade": State.OPEN,
        "account": State.OPEN,
