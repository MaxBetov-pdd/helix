...
"1h" (helix/strategies/intake.py), and the gauntlet gates -- including the
...
from helix.strategies.intake import _intended_timeframe
from helix.strategies.params import _COMMON_ALLOWED_PARAMS
