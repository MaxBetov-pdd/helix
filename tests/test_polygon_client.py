...
from helix.polygon_client import PolygonClient, PolygonAuthError


@pytest.fixture
def mock_client():
    """Create a PolygonClient with a fake key and mocked httpx."""
    with patch("helix.polygon_client.get_polygon_api_key", return_value="test_key_1234"):
...
def test_init_requires_api_key():
    with patch("helix.polygon_client.get_polygon_api_key", return_value=None):
