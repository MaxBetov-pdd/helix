...
def test_promotion_not_blocked_when_funding_complete(helix_db, monkeypatch):
    import helix.policy as policy
...
def test_promotion_not_blocked_when_setting_off(helix_db, monkeypatch):
    import helix.policy as policy
...
def test_promotion_not_blocked_for_pre_feature_metrics(helix_db, monkeypatch):
