...
from helix.api_domains.data import get_coverage
...
def test_coverage_entry_uses_mtime_cache(tmp_path):
    ...
    with patch("helix.data.pq.read_metadata", side_effect=AssertionError("re-read on cache hit")):
