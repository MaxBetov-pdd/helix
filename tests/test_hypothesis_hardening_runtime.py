...
def test_create_strategy_container_persists_hypothesis_id(helix_db):
...
def test_autonomous_strategy_research_with_hypothesis_creation_skips_generic_brain_callback(helix_db):
...
def test_manual_or_nonresearch_tasks_still_queue_brain_callback(helix_db):
    from helix.agents import runner
    from helix.agents.manager import create_agent
