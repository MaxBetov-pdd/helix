...
def test_artifacts_pending_rejections_never_auto_archive(helix_db):
...
def test_stale_validation_rejections_never_auto_archive(helix_db):
...
def test_missing_evidence_rejections_never_auto_archive(helix_db):
...
def test_quality_failure_rejections_still_auto_archive(helix_db):
...
def test_insufficient_paper_evidence_rejections_never_auto_archive_or_dethrone(helix_db):
...
def test_paper_quality_failures_do_not_auto_queue_dethrone_for_operator_owned(helix_db):
