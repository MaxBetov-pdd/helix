from helix.api_core import _diff_settings_section, _append_settings_audit
...
def test_put_settings_section_writes_audit(helix_db):
    ...
    from helix.api_core import put_settings_section, get_settings
...
def test_get_settings_audit_log_returns_newest_first(helix_db):
    from helix.api_core import put_settings_section, get_settings_audit_log
...
def test_get_settings_audit_log_respects_limit(helix_db):
    from helix.api_core import put_settings_section, get_settings_audit_log
