"""Tests for helix.security.env_allowlist — subprocess env filter."""
...
def test_helix_vars_pass():
    base = {"PATH": "/x", "HELIX_HOME": "/home/x/.helix", "HELIX_PROFILE": "default"}
    env = build_subprocess_env(base=base)
    assert env["HELIX_HOME"] == "/home/x/.helix"
    assert env["HELIX_PROFILE"] == "default"
