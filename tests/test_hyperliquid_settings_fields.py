...
def test_hyperliquid_settings_accept_actual_wallet_api_fields(helix_db):
    ...
    secrets = core.kv_get("helix:settings:secrets", {}) or {}
    assert secrets.get("hyperliquid_private_key") == "0x" + ("1" * 64)


def test_hyperliquid_settings_accept_canonical_field_names(helix_db):
    import helix.api_core as core
...
def test_hyperliquid_private_key_update_preserves_existing_api_address(helix_db):
    import helix.api_core as core
