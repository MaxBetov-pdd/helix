...
GATE A (helix.policy._implausible_metrics_reason): reject Sharpe >= 5 / PF >= 8
...
GATE B (helix.strategies.lookahead_probe.detect_lookahead): a truncation-
...
def test_quick_screen_rejects_leak_metrics(helix_db):
...
def test_quick_screen_passes_sane_strategy(helix_db):
