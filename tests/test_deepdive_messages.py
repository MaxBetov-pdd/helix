...
def test_append_user_message(helix_db):
...
def test_list_messages_in_order(helix_db):
...
def test_append_tool_message_persists_json(helix_db):
...
def test_thread_cost_total_empty_and_populated(helix_db):
    from helix.deepdive_db import thread_cost_total
