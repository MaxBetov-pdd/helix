...
def test_paper_wip_default_allows_unattended_rotation(helix_db):
...
def test_paper_wip_override_can_still_enforce_tighter_cap(helix_db):
...
def test_paper_wip_override_can_be_unlimited(helix_db):
    from helix.db import get_db, kv_set
    from helix.lab_features import check_stage_wip_capacity
...
def test_pipeline_settings_can_set_paper_wip_unlimited(helix_db):
...
def test_pipeline_settings_can_set_paper_wip_cap(helix_db):
    from helix.api_core import PipelineSettingsUpdateBody, put_pipeline_settings
...
def test_pipeline_settings_can_set_graveyard_strategy_limit_unlimited(helix_db):
...
def test_strategy_query_limit_honors_graveyard_strategy_cap(helix_db):
    from helix.api_core import (
        PipelineSettingsUpdateBody,
        configured_graveyard_strategy_limit,
        put_pipeline_settings,
