...
def test_get_auxiliary_routing_exposes_configured_fallbacks(helix_db):
...
def test_tool_call_chain_uses_per_agent_fallbacks(helix_db):
    from helix.agents.runner import _resolve_tool_call_chain
