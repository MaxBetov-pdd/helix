...
def test_post_optimization_submit_uses_executor(monkeypatch, helix_db):
...
def test_post_optimization_submit_forwards_window_objective_and_execution_controls(monkeypatch, helix_db):
    ...
    monkeypatch.setattr("helix.strategies.optimizer.optimize_strategy", _fake_optimize_strategy)
...
def test_post_optimization_submit_persists_named_failure_details(monkeypatch, helix_db):
    ...
    monkeypatch.setattr(api_core, "_OPTIMIZATION_EXECUTOR", _ImmediateExecutor())
    monkeypatch.setattr("helix.strategies.optimizer.optimize_strategy", _raise_timeout)
...
def test_get_backtest_result_preserves_failed_optimization_status(helix_db):
