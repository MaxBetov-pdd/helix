...
from helix.research_contract import build_research_contract, default_research_settings


def test_build_research_context_excludes_chroma_by_default():
    from helix.research_context import build_research_context
...
def test_build_research_context_includes_strategy_diversity_guard(monkeypatch):
    ...
    monkeypatch.setattr(
        "helix.research_context.render_strategy_diversity_guard",
...
def test_coerce_research_contract_tolerates_invalid_spawn_limits():
    from helix.research_context import coerce_research_contract
...
def test_run_agent_task_uses_research_context_for_research_tasks(helix_db, monkeypatch):
