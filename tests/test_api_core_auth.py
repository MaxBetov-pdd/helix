...
def test_lmstudio_tool_provider_omits_auth_header_without_token(monkeypatch):
    from helix.agents import providers
...
def test_model_policy_save_preserves_auxiliary(helix_db):
    """Saving model-policy must NOT reset auxiliary routing to the defaults."""
    from helix import model_routing
...
def test_auth_provider_connected_matches_runtime_gate(helix_db, monkeypatch):
...
def test_model_policy_save_warns_on_not_connected_provider(helix_db, monkeypatch):
...
def test_model_policy_save_no_warnings_when_all_connected(helix_db, monkeypatch):
    from helix import model_selection as ms
...
def test_patch_agent_model_warns_on_not_connected_provider(helix_db, monkeypatch):
    from helix import model_selection as ms
...
def test_patch_agent_model_no_warning_when_connected(helix_db, monkeypatch):
    from helix import model_selection as ms
    from helix.db import get_db
