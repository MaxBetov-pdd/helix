...
def _patch_gate(monkeypatch, transition):
    from helix.gauntlet import tasks
...
def test_wip_cap_block_is_gate_contention(monkeypatch):
    ...
    from helix.gauntlet.engine import _step_block_reason_code, _NO_DRAIN_REASON_CODES
...
def test_other_transient_block_stays_bounded(monkeypatch):
    ...
    from helix.gauntlet.engine import _step_block_reason_code
