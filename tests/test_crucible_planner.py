...
def test_empty_fresh_install_plans_one_propose_crucible_action(helix_db):
    from helix.crucible_planner import plan_next_actions
...
def test_researching_crucible_without_strategies_routes_to_candidate_development(helix_db):
    from helix.crucible_planner import plan_next_actions
...
def test_planner_defers_develop_candidate_when_one_is_in_flight(helix_db):
...
def test_exhausted_researching_crucible_does_not_consume_planner_slot(helix_db):
    from helix.crucible_planner import plan_next_actions
...
def test_all_researching_crucibles_spawn_exhausted_proposes_replacement(helix_db):
    from helix.crucible_planner import plan_next_actions
...
def test_settled_research_pool_proposes_replacement_when_no_busy_work(helix_db):
    from helix.crucible_planner import plan_next_actions
...
def test_busy_strategy_does_not_block_replenishment_when_pool_is_exhausted(helix_db):
    from helix.crucible_planner import plan_next_actions
...
def test_active_proposed_crucible_blocks_extra_replenishment(helix_db):
    from helix.crucible_planner import plan_next_actions
...
def test_backtest_failed_strategy_does_not_block_new_candidate(helix_db):
    from helix.crucible_planner import plan_next_actions
...
def test_graduated_protected_proven_crucible_expands_instead_of_proposing(helix_db):
    from helix.crucible_planner import plan_next_actions
...
def test_protected_proven_crucible_with_prior_completed_expansion_does_not_expand_again(helix_db):
    from helix.crucible_planner import plan_next_actions
...
def test_protected_proven_crucible_with_prior_cancelled_expansion_does_not_expand_again(helix_db):
    from helix.crucible_planner import plan_next_actions
...
def test_protected_proven_crucible_without_prior_expansion_gets_first_expansion(helix_db):
    from helix.crucible_planner import plan_next_actions
...
def test_proposed_active_crucible_routes_to_refinement(helix_db):
    from helix.crucible_planner import plan_next_actions
...
def test_proposed_crucible_with_completed_refinement_routes_to_candidate_development(helix_db):
    from helix.crucible_planner import plan_next_actions
...
def test_proposed_crucible_with_narrative_only_refinement_retries_refinement(helix_db):
    from helix.crucible_planner import plan_next_actions
...
def test_proposed_crucible_with_expired_refinements_retries_refinement(helix_db):
    from helix.crucible_planner import plan_next_actions
...
def test_preempted_refinement_does_not_poison_crucible_action(helix_db):
    from helix.crucible_planner import plan_next_actions
...
def test_researching_crucible_with_untested_strategy_routes_to_backtest(helix_db):
    from helix.crucible_planner import plan_next_actions
...
def test_mismatched_strategy_lineage_does_not_satisfy_crucible_candidate_need(helix_db):
    from helix.crucible_planner import plan_next_actions
...
def test_open_matching_action_dedupes_pending_task(helix_db):
    from helix.crucible_planner import plan_next_actions
...
def test_open_matching_action_dedupes_running_task(helix_db):
    from helix.crucible_planner import plan_next_actions
...
def test_run_cycle_assigns_planned_task_with_crucible_planner_input(helix_db):
...
def test_planner_defers_strategy_developer_action_when_in_flight_cap_reached(helix_db):
    ...
    from helix.crucible_planner import run_crucible_planner_cycle
    from helix.hypothesis_promotion import MAX_IN_FLIGHT_DEFAULT
...
def test_planner_backtest_action_not_blocked_by_strategy_developer_cap(helix_db):
...
def test_candidate_action_open_treats_develop_and_expand_as_one_family(helix_db):
    from helix.crucible_planner import CrucibleTaskIndex
...
def test_parked_researching_crucible_is_archived_and_does_not_suppress_replenishment(helix_db):
...
def test_parked_protected_crucible_is_never_auto_archived(helix_db):
...
def test_researching_crucible_below_retry_cap_is_not_archived(helix_db):
...
def test_proven_crucible_defers_to_open_develop_candidate(helix_db):
    from helix.crucible_planner import plan_next_actions
