...
from helix.db import init_db, kv_set
...
def test_h_r4_phantom_future_exception_is_logged(caplog):
    ...
    from helix.phantom_recovery import _log_phantom_future_exception

    future: Future = Future()
    callback = _log_phantom_future_exception("SOCRATES-001", context="unit-test")

    with caplog.at_level("ERROR", logger="helix.phantom_recovery"):
...
def test_h_r5_health_status_exposes_unavailable_flag():
    from helix.routers.health import get_health_status
