...
from helix.api_domains import hypotheses as hypotheses_domain
from helix.db import get_db


@pytest.fixture
def seeded_hypothesis(helix_db):
...
def test_generate_strategies_missing_hypothesis_404(helix_db):
...
@pytest.fixture
def placeholder_hypothesis(helix_db):
