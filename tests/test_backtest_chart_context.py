...
from helix.api_core import BacktestSubmitBody, post_backtest_submit
...
def _configure_chart_paths(home: Path, monkeypatch) -> Path:
	import helix.api_core as api_core
	import helix.data as data_mod
...
def test_chart_context_returns_artifact_for_new_backtests(helix_db, _isolate_helix_home, monkeypatch):
	results_dir = _configure_chart_paths(_isolate_helix_home, monkeypatch)
	_seed_local_candles()
	strategy_id = _seed_strategy()

	import helix.strategies.backtest as backtest_mod
...
def test_chart_context_recomputes_for_snapshotless_builtin_run(helix_db, _isolate_helix_home, monkeypatch):
	_configure_chart_paths(_isolate_helix_home, monkeypatch)
	_seed_local_candles()
...
def test_chart_context_skips_audit_lookup_when_result_payload_already_resolves_context(helix_db, _isolate_helix_home, monkeypatch):
	_configure_chart_paths(_isolate_helix_home, monkeypatch)
	_seed_local_candles()
...
def test_chart_context_gracefully_falls_back_for_unsupported_strategy(helix_db, _isolate_helix_home, monkeypatch):
	_configure_chart_paths(_isolate_helix_home, monkeypatch)
	_seed_local_candles()
...
def test_chart_context_warns_when_local_ohlcv_is_missing(helix_db, _isolate_helix_home, monkeypatch):
	_configure_chart_paths(_isolate_helix_home, monkeypatch)
...
def test_chart_context_fast_fails_when_pyarrow_is_unavailable_for_parquet(helix_db, _isolate_helix_home, monkeypatch):
	_configure_chart_paths(_isolate_helix_home, monkeypatch)
...
def test_chart_context_fetches_remote_ohlcv_when_local_dataset_is_unreadable(helix_db, _isolate_helix_home, monkeypatch):
	_configure_chart_paths(_isolate_helix_home, monkeypatch)
