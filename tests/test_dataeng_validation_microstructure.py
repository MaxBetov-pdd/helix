...
def test_build_source_registry_honors_enabled_exchanges():
    from helix.dataeng.registry import build_source_registry, resolve_source_for_stream
    from helix.dataeng.settings import DataEngineSettings
...
def test_cross_source_validator_flags_and_priority_resolves_divergent_bars():
    from helix.dataeng.validation import validate_bars
...
def test_derivatives_basis_and_aggregated_oi():
    from helix.dataeng.derivatives import aggregate_open_interest, perp_spot_basis
...
def test_microstructure_writer_reader_and_rollup(tmp_path):
    from helix.dataeng.microstructure import read_micro_rows, rollup_trades_per_minute, write_micro_rows
...
def test_onchain_source_disabled_without_key_and_parses_fixture():
    from helix.dataeng.onchain import OnChainSource
    from helix.dataeng.source import Stream
