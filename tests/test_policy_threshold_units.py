...
from helix.policy import _validation_row_to_verdict_payload, load_pipeline_config, save_pipeline_config


def test_save_pipeline_config_accepts_percent_points(helix_db):
    ...
    stored = kv_get("helix:pipeline_thresholds", {})
...
def test_load_pipeline_config_heals_legacy_percent_point_values(helix_db):
    kv_set(
    ...
    healed = kv_get("helix:pipeline_thresholds", {})
...
def test_wfa_fold_pass_rate_min_accepts_percent_points_and_fraction_identically(helix_db):
...
def test_wfa_fold_pass_rate_min_clamps_to_unit_interval(helix_db):
...
def test_wfa_fold_gate_passes_with_legacy_percent_point_floor(helix_db):
