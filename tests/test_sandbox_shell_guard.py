"""Tests for helix.sandbox.shell_guard (P2-T07)."""
...
from helix.sandbox.shell_guard import (
    ShellFinding,
    ShellReport,
...
def test_evaluate_strict_mode_upgrades_high(monkeypatch):
    ...
    monkeypatch.setattr(
        "helix.sandbox.shell_guard.is_strict_mode_enabled", lambda: True
    )
...
def test_scanner_failure_fails_open():
    ...
    with patch(
        "helix.sandbox.shell_guard._PATTERNS",
