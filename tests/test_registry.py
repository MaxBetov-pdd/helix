...
from helix.strategies.custom_catalog import custom_strategy_status
...
def test_get_active_skips_bad_row_and_loads_non_execution_owner(helix_db):
    registry_mod.reset()
...
def test_get_active_backfills_runtime_type_from_unique_prefix_match(helix_db):
    registry_mod.reset()
