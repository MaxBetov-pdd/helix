...
def test_quota_is_down_and_recovers_on_ok(helix_db):
...
def test_kind_to_state_classification(helix_db):
    prh.clear_provider_health()
...
def test_down_sorts_first(helix_db):
    prh.clear_provider_health()
...
def test_fallback_event_records_target(helix_db):
    prh.clear_provider_health()
