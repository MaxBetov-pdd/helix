...
"""
from helix.research_sources import podcast
from helix.research_sources.url_ingest import detect_source_type
...
def test_registry_resolves_podcast(monkeypatch):
    from helix.research_sources import _registry
