...
from helix.agents.providers import (
    DeepSeekProvider,
    OpenAIProvider,
    ProviderResponse,
    ToolCall,
...
def test_deepseek_default_endpoint() -> None:
    with patch("helix.agents.providers.get_profile", return_value=None):
...
def test_deepseek_endpoint_override() -> None:
    with patch(
        "helix.agents.providers.get_profile",
...
def test_deepseek_call_returns_tool_calls() -> None:
    ...
    with patch("helix.agents.providers.httpx.AsyncClient", return_value=mock_client), \
         patch("helix.agents.providers.get_profile", return_value=None):
