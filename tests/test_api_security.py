...
from helix.api_security import ApiKeyMiddleware, get_allowed_cors_origins, require_operator_access
...
def test_allowed_cors_origins_default_to_explicit_local_hosts(monkeypatch):
    monkeypatch.delenv("HELIX_CORS_ORIGINS", raising=False)
    monkeypatch.setenv("FRONTEND_PORT", "4173")
    monkeypatch.setenv("HELIX_PORT", "9003")
