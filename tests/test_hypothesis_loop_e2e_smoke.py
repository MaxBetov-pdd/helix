...
from helix.hypothesis_graduation import is_canonical
...
def test_e2e_full_discipline_lifecycle(helix_db):
    ...
    with patch("helix.hypothesis_verdict._call_llm", return_value=fake_llm_response):
