...
def test_check_chroma_available_uses_valid_probe_payload(monkeypatch):
    import helix.vectordb as vectordb

    # This test exercises the subprocess probe path. Importing helix.api sets
    # HELIX_DISABLE_CHROMA_IN_PROCESS on Windows, which short-circuits the probe
    ...
    assert "'source': 'helix_health_check'" in script
