...
def test_ccxt_source_fetches_candles_funding_and_oi_from_exchange_fixture():
    ...
    from helix.dataeng.source import Stream
...
def test_funding_and_oi_collectors_use_source_registry_when_enabled(helix_db, tmp_path, monkeypatch):
    from helix import api_core
    from helix.data_manager import FundingCollector, OICollector
    ...
    monkeypatch.setattr("helix.data_manager._fetch_stream_via_source_registry", fake_fetch)
    monkeypatch.setattr(
