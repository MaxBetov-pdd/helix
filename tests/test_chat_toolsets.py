...
The operator <-> Helix chat exposes two read/act tiers defined ONCE in
``helix.agents.tool_definitions``:
...
(importing ``helix.agents.runner`` triggers tool registration), that the Ask
...
def _registry():
    ...
    import helix.agents.runner  # noqa: F401
    from helix.agents.tool_definitions import _ensure_tools_imported
...
def test_validate_helper_reports_no_missing():
    from helix.agents.tool_definitions import _validate_chat_toolsets
