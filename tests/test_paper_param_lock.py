...
def test_update_params_paper_system_is_blocked(helix_db):
...
def test_update_params_paper_ui_is_allowed(helix_db):
...
def test_update_params_gauntlet_system_is_allowed(helix_db):
...
def test_update_params_live_evolution_is_blocked(helix_db):
...
def test_metric_sync_skips_paper_strategy(helix_db):
    ...
    from helix.strategies import backtest as bt
...
def test_metric_sync_updates_gauntlet_strategy(helix_db):
...
def test_list_active_workflow_ids_excludes_paper(helix_db):
    from helix.gauntlet.engine import list_active_workflow_ids
...
def test_cancel_param_locked_workflows_drains_paper(helix_db):
    from helix.gauntlet.engine import cancel_param_locked_workflows
